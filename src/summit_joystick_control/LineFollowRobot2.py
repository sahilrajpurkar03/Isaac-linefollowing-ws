...
class LineFollowRobot2(Node):
    def __init__(self):
        super().__init__('line_follow_robot_2')
    ...
    def detect_junction(self, thresh_img):
        ...
        if junction_contour_count >= 2 and not self.junction_detected:
            ...
            if self.junction_crossing_timer is None:
                self.junction_crossing_timer = self.create_timer(6.0, self.end_junction_crossing)
